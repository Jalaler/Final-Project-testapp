...
function SubjectDetailPage() {
    ...
    return (
        <div>
                    ...
                    <div>
                        <div class="flex items-center">
                            ...
                            <div class="rounded-l-full w-full pl-8 text-black">
                                <p class="text-lg font-bold">{list.subject_name}</p>
                                <p class="text-md text-gray-black">({list.subject_name})</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex items-center">
            ...
            <div class="mr-80 ml-4">
                {/* <div class="mt-8 relative flex justify-center mr-96">
                    ...
                    <select class="border border-gray-300 rounded-full font-semibold text-gray-600 h-10 pl-6 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none shadow-md">
                        <option>Semester 1 Academic Year 2021</option>
                        <option>Semester 2 Academic Year 2020</option>
                        <option>Semester 1 Academic Year 2020</option>
