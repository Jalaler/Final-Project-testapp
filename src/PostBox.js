                ...
                <section class="shadow-lg row rounded-xl bg-yellow-100 bg-opacity-5">
                    <div class="tabs">
                        ...
                        <div class="border-t-2 border-b-4 border-l-4 border-r-4 border-yellow-400 border-opacity-50 rounded-b-xl bg-yellow-300 bg-opacity-5">
                            ...
                            <div class="pt-6 pl-14 pb-6 font-bold border-t-2 border-yellow-400 border-opacity-50 border-transparent relative">
                                Comments
                            </div>
                            <div class="relative">
                                <div class="ml-20 mr-20 bg-white rounded-lg p-3 flex flex-col justify-center items-center md:items-start shadow-lg mb-4">
                                    <div class="flex flex-row justify-center p-1">
                                        ...
                                        <h3 class="text-yellow-600 font-semibold text-md text-center md:text-left pl-2 pt-1">@Rabbit Man</h3>
                                    </div>
                                    <p class="text-gray-600 text-md text-center md:text-left pt-2 pl-1"><span class="text-yellow-600 font-semibold">@Crocodile</span> Hello. Yes, the entire exterior, including the walls. </p>
                                </div>
                            </div>
                            <div class="relative">
                                <div class="ml-20 mr-20 bg-white rounded-lg p-3 flex flex-col justify-center items-center md:items-start shadow-lg mb-4">
                                    <div class="flex flex-row justify-center p-1">
                                        ...
                                        <h3 class="text-yellow-600 font-semibold text-md text-center md:text-left pl-2 pt-1">@Crocodile</h3>
                                    </div>
                                    <p class="text-gray-600 text-md text-center md:text-left pt-2 pl-1"><span class="text-yellow-600 font-semibold">@Rabbit Man</span> Yes, the entire exterior, including the walls. </p>
                                </div>
                            </div>
                            <div class="flex justify-center items-center mt-8 ml-20 mr-20">
                            ...
                            <div class="flex justify-end pr-20 pt-2 pb-7">
