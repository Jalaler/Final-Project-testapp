    ...
    return (
        <div>
            <button type="button" onClick={handleOpen}>
                <div class="flex items-center pt-4 pl-64">
                        ...
                        <div class="flex flex-col space-y-10 justify-center items-center">
                            <div class="bg-white w-96 shadow-lg rounded-lg p-10">
                                <div class="">
                                    ...
                                    <a href="http://localhost:5000/api/auth/google" class="flex items-center justify-center mt-8 text-white rounded-lg shadow-md hover:bg-gray-100">
                                        <div class="px-4 py-3">
